    ...
    <div className="group text-center">
      <div className="flex flex-col items-center">
        ...
        <div className="mb-6 relative">
          <div className={`w-16 h-16 rounded-full ${stepColors[index]} flex items-center justify-center text-2xl shadow-gold group-hover:shadow-gold-lg transition-all duration-300 transform group-hover:scale-110`}>
            {stepIcons[index] || '✨'}
          </div>
        </div>
